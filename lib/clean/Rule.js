...
module.exports = function cleanRuleset(node, item, list, options) {
    ...
    if ((node.prelude && node.prelude.children && node.prelude.children.isEmpty()) ||
        (node.prelude && !node.prelude.children) ||
        (node.block && node.block.children && node.block.children.isEmpty()) ||
