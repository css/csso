...
TRBL.prototype.getValue = function() {
    ...
    if (isEqualValuePair(values[LEFT], values[RIGHT])) {
        values.pop();
        if (isEqualValuePair(values[BOTTOM], values[TOP])) {
            values.pop();
            if (isEqualValuePair(values[RIGHT], values[TOP])) {
                values.pop();
            }
        }
    }
...
function isEqualValuePair(left, right) {
    return (
