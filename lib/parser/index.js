...
function getBlock() {
    ...
    while (pos < end) {
        if (checkDeclaration(pos)) {
            ...
            throw new Error('Valid declaration expected');
        }
    }
...
function getFunctionBody() {
    ...
    while (tokens[pos].type !== TokenType.RightParenthesis) {
        if (checkTset(pos)) {
            ...
            throw new Error('Bad value for function argument');
        }
    }
...
function getNotFunctionBody() {
    ...
    while (tokens[pos].type !== TokenType.RightParenthesis) {
        if (checkSimpleselector(pos)) {
            ...
            throw new Error('Simple selector expected');
        }
    }
...
function getStylesheet() {
    ...
    for (; pos < tokens.length;) {
        ...
        else throw new Error('Valid ruleset or at-rule expected');
