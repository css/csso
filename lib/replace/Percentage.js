...
module.exports = function compressPercentage(node, item) {
    ...
    var func = this['function'] !== null ? this['function'].name : null;

    node.value = value;

    if (
        (property !== null && PERCENTAGE_LENGTH_PROPERTY.hasOwnProperty(property)) ||
        (func !== null && PERCENTAGE_LENGTH_FUNCTION.hasOwnProperty(func))
    ) {
        if (value === '0') {
            item.data = {
                type: 'Number',
