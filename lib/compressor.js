...
CSSOCompressor.prototype.cleanWhitespace = function(token, rule, container, i) {
    ...
    if (nr === 'unknown') token[2] = '\n';
        ...
        if (!(container[1] === 'atrulerq' && !pr) && !this.issue16(container, i) && !this.issue165(container, pr)) {
            if (nr !== null && pr !== null) {
...
CSSOCompressor.prototype.issue165 = function(container, pr) {
    return container[1] === 'atrulerq' && pr === 'braces';
};
