...
function pseudoSelectorSignature(selector, exclude, dontAppendExcludeMark) {
    var pseudos = {};
...
function freeze(node) {
    ...
    info.pseudoSignature = pseudoSelectorSignature(selector, constants.allowedPClasses, true);
