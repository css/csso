...
module.exports = function markShorthands(ruleset, parent) {
    ...
    ruleset.block.declarations.eachRight(function(declaration, item) {
        ...
        if (property in TRBL.props) {
            ...
            if (!shorthand) {
                shorthand = new TRBL(property);
                operation = REPLACE;
            }

            shorthand.add(property, value);
