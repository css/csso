...
function processShorthands(shortDeclarations, indexer) {
    shortDeclarations.forEach(function(item) {
        ...
        indexer.declaration.remove(item.item.data);
        ...
        if (item.operation === REPLACE) {
            ...
            item.item.data = newNode;
            indexer.declaration.add(newNode);
        } else {
...
module.exports = function restructBlock(ast, indexer) {
    ...
    processShorthands(shortDeclarations, indexer);
};
