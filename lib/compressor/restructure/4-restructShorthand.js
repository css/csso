...
TRBL.prototype.getValueSequence = function(declaration, count) {
    var values = [];
    var iehack = false;
    var hasBadValues = declaration.value.sequence.some(function(child) {
        var special = false;
...
function processRule(ruleset, shorts, shortDeclarations, lastShortSelector) {
...
module.exports = function restructBlock(ast, indexer) {
    ...
    walkRulesRight(ast, function(node) {
        ...
        rulesetMap.lastShortSelector = processRule.call(this, node, shorts, shortDeclarations, rulesetMap.lastShortSelector);
    });
