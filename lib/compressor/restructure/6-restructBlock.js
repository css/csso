            ...
            switch (node.type) {
                ...
                case 'Function':
                    ...
                    if (name === 'rect') {
                        ...
                        var hasComma = node.sequence.some(function(node) {
...
function processRule(rule, item, list, props, fingerprints) {
    var declarations = rule.block.declarations;
...
module.exports = function restructBlock(ast) {
    ...
    walkRulesRight(ast, function(node, item, list) {
        ...
        var ruleId = (node.pseudoSignature || '') + '|' + node.selector.selectors.first().id;
        var ruleMap;
        var props;
