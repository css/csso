...
function getPropertyInfo(name) {
    ...
    var info = propertyInfoMap.get(name);
...
function getPropertyFingerprint(propertyName, declaration, fingerprints) {
    ...
    var fingerprint = fingerprints.get(declarationId);
    ...
    if (!fingerprint) {
        ...
        fingerprints.set(declarationId, fingerprint);
    }
