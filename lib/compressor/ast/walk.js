...
function walkAll(node, parent, array, index) {
    ...
    switch (node.type) {
        ...
        case 'Function':
            node.arguments.each(function(data, item) {
                return walkAll.call(this, data, node, node.arguments, item);
            }, this);
            break;
        ...
        case 'Selector':
            node.selectors.each(function(data, item) {
                return walkAll.call(this, data, node, node.selectors, item);
            }, this);
            break;
        ...
        case 'Braces':
        case 'Negation':
            node.sequence.each(function(data, item) {
                return walkAll.call(this, data, node, node.sequence, item);
            }, this);
            break;
