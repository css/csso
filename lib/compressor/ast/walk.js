...
function listEach(list, walker, parent) {
    list.each(function(data, item) {
        return walker.call(this, data, parent, list, item);
    }, this);
}
...
function walkAll(node, parent, array, index) {
    ...
    switch (node.type) {
        ...
        case 'Function':
            listEach.call(this, node.arguments, walkAll, node);
            break;

        case 'Block':
            listEach.call(this, node.declarations, walkAll, node);
            break;
        ...
        case 'Selector':
            listEach.call(this, node.selectors, walkAll, node);
            break;
        ...
        case 'Braces':
        case 'Negation':
            listEach.call(this, node.sequence, walkAll, node);
            break;
