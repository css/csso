...
List.prototype.each = function(fn, context) {
    ...
    while (cursor.next) {
        ...
        fn.call(context || this, item.data, item, this);
    }
...
List.prototype.nextUntil = function(start, fn, context) {
    ...
    while (cursor.next) {
        ...
        if (fn.call(context || this, item.data, item, this)) {
            break;
        }
    }
...
List.prototype.some = function(fn, context) {
    ...
    while (cursor) {
        if (fn.call(context || this, cursor.data, cursor, this)) {
            return true;
        }
...
List.prototype.map = function(fn, context) {
    ...
    while (cursor) {
        result.push(fn.call(context || this, cursor.data, cursor, this));
        cursor = cursor.next;
    }
