...
- [2. Минимизация](#2-минимизация)
	- [2.1. Минимизация без изменения структуры](#21-минимизация-без-изменения-структуры)
		- [2.1.1. Удаление whitespace](#211-удаление-whitespace)
		- [2.1.2. Удаление концевых ';'](#212-удаление-концевых-';')
		- [2.1.3. Удаление комментариев](#213-удаление-комментариев)
		- [2.1.4. Удаление неправильных @charset и @import](#214-удаление-неправильных-@charset-и-@import)
		- [2.1.5. Минимизация цвета](#215-минимизация-цвета)
		- [2.1.6. Минимизация 0](#216-минимизация-0)
		- [2.1.7. Слияние многострочных строк в однострочные](#217-слияние-многострочных-строк-в-однострочные)
		- [2.1.8. Минимизация font-weight](#218-минимизация-font-weight)
	- [2.2. Минимизация с изменением структуры](#22-минимизация-с-изменением-структуры)
		- [2.2.1. Слияние блоков с одинаковыми селекторами](#221-слияние-блоков-с-одинаковыми-селекторами)
		- [2.2.2. Слияние блоков с одинаковыми свойствами](#222-слияние-блоков-с-одинаковыми-свойствами)
		- [2.2.3. Удаление перекрываемых свойств](#223-удаление-перекрываемых-свойств)
			- [2.2.3.1. Удаление перекрываемых shorthand свойств](#2231-удаление-перекрываемых-shorthand-свойств)
		- [2.2.4. Удаление повторяющихся селекторов](#224-удаление-повторяющихся-селекторов)
		- [2.2.5. Частичное слияние блоков](#225-частичное-слияние-блоков)
		- [2.2.6. Частичное разделение блоков](#226-частичное-разделение-блоков)
		- [2.2.7. Удаление пустых ruleset и at-rule](#227-удаление-пустых-ruleset-и-at-rule)
		- [2.2.8. Минимизация margin и padding](#228-минимизация-margin-и-padding)
		- [2.2.9. Специальная минимизация псевдоклассов](#229-специальная-минимизация-псевдоклассов)
			- [2.2.9.1. Сохранение группы](#2291-сохранение-группы)
			- [2.2.9.2. Минимизация общеподдерживаемых псевдоклассов и псевдоэлементов](#2292-минимизация-общеподдерживаемых-псевдоклассов-и-псевдоэлементов)
			- [2.2.9.3. Минимизация :before и :after](#2293-минимизация-before-и-after)
- [3. Рекомендации](#3-рекомендации)
	- [3.1. Длина селекторов](#31-длина-селекторов)
	- [3.2. Порядок свойств](#32-порядок-свойств)
	- [3.3. Расположение схожих блоков](#33-расположение-схожих-блоков)
	- [3.4. Использование !important](#34-использование-!important)
